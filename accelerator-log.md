...
```json
{
  ...
  "javaVersion" : "11",
  "nativeBuild" : false,
  "projectName" : "tanzu-java-web-test-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-java-web-test-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: tanzu-java-web-tes...(truncated)]
